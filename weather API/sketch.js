...
//print(tempforcast1);
  ...
  textAlign(RIGHT);
    ...
    fill(0)
    text("Speed:",50,windowHeight - 50);
    text(windSpeed, 80, windowHeight - 50);
    fill(246,255,0);
    text("Temperature:",90, windowHeight - 30);
    text(temp, 120, windowHeight - 30);
    fill(0,0,255);
    text("Wind direction:",100,windowHeight - 10);
    text(windDirection,130, windowHeight - 10);
  ...
  triangle(windDirection, 100, 320, 100, 310, 80);
